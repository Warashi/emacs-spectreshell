...
# emacs-module 境界と spectreshell.el 描画エンジンの ERT テスト一式
test-el: build
  emacs -Q --batch -L . -L test -l test/spectreshell-module-test.el -l test/spectreshell-test.el -f ert-run-tests-batch-and-exit

...
# emacs-module 境界と spectreshell.el 描画エンジン・キー入力の ERT テスト一式
test-el: build
  emacs -Q --batch -L . -L test -l test/spectreshell-module-test.el -l test/spectreshell-test.el -l test/spectreshell-key-test.el -f ert-run-tests-batch-and-exit
